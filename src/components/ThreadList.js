...
const ThreadList = ({ threads, rowsPerPage, page, handleChangePage, handleChangeRowsPerPage }) => {
  ...
  return (
    <Paper>
      <Table>
        ...
        <TableBody>
          {paginatedThreads.map((thread) => <ThreadListItem key={thread.id} thread={thread} />)}
          {placeholderRows > 0 && (
